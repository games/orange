...
void _renderDepth() {
  ...
  renderer.pass.shader = depthShader;
  renderer.prepare();
  ...
  renderer.draw(mesh1);
  renderer.draw(mesh2);
  if (teapot != null) renderer.draw(teapot);
...
void _renderScene() {
  ...
  renderer.pass.shader = sceneShader;
  renderer.prepare();
...
void _renderMapping() {
  ...
  renderer.pass.shader = showMappingShader;
