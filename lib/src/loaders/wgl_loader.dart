...
//      }
      if(v.containsKey("submeshes")) {
        v["submeshes"].forEach((sv) {
          ...
          subMesh.indicesAttrib = new VertexBuffer(2, gl.UNSIGNED_SHORT, 0, offset, count);

          var attrib;
          subMesh.attributes = {};
          attrib = new VertexBuffer(3, gl.FLOAT, _stride, offset, count);
          subMesh.attributes[Semantics.position] = attrib;
          offset += 12;
          if(_format & ModelVertexFormat.UV > 0) {
            attrib = new VertexBuffer(2, gl.FLOAT, _stride, offset, count);
          ...
          if(_format & ModelVertexFormat.Color > 0) {
            attrib = new VertexBuffer(4, gl.UNSIGNED_BYTE, _stride, offset, count);
          ...
          if(_format & ModelVertexFormat.BoneWeights > 0) {
            ...
            attrib = new VertexBuffer(3, gl.FLOAT, _stride, offset + 12, count);
