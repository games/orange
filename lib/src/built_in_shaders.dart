...
uniform mat4 modelMat;
uniform mat4 projectionMat;
uniform mat4 jointMat[$MAX_JOINTS_PER_MESH];
...
mat4 accumulateSkinMat() {
   mat4 result = weights.x * jointMat[int(joints.x)];
   result = result + weights.y * jointMat[int(joints.y)];
   result = result + weights.z * jointMat[int(joints.z)];
   result = result + weights.w * jointMat[int(joints.w)];
   return result;
}
